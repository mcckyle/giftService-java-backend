...
package com.mcckyle.giftplanner.security.jwt;
...
public class JwtUtils
{
                                   ...
                                   Collection<? extends GrantedAuthority> authorities)
    {
        ...
        return Jwts.builder()
                .setIssuer("giftplanner")
                .setAudience("giftplanner-client")
                .setId(jti)
    ...
    public Claims getClaimsFromToken(String token)
    {
        try
        {
            return Jwts.parserBuilder()
                    .requireIssuer("giftplanner")
                    .requireAudience("giftplanner-client")
